...
const BreadcrumbList = forwardRef<HTMLOListElement, BreadcrumbListProps>(
  ({ className, children, ...props }, ref) => (
    <ol
      ref={ref}
      className={cn(
        'text-tsinelas-text-disabled flex flex-wrap items-center gap-2 text-sm',
        className
      )}
      {...props}
    >
...
const BreadcrumbLink = forwardRef<HTMLAnchorElement, BreadcrumbLinkProps>(
  ({ className, href, children, ...props }, ref) => (
    <Link
      ...
      to={href}
      className={cn(
        'hover:text-tsinelas-text-strong text-tsinelas-text-disabled font-medium transition-colors',
        className
      )}
      {...props}
    >
...
const BreadcrumbPage = forwardRef<HTMLSpanElement, BreadcrumbPageProps>(
  ({ className, children, ...props }, ref) => (
    <span
      ...
      aria-disabled='true'
      aria-current='page'
      className={cn('text-tsinelas-text-strong font-bold', className)}
      {...props}
    >
      {children}
    </span>
...
const BreadcrumbSeparator = ({
  ...
  <li
    role='presentation'
    aria-hidden='true'
    className={cn('text-tsinelas-text-disabled', className)}
    {...props}
  >
...
const BreadcrumbHome = forwardRef<HTMLAnchorElement, BreadcrumbLinkProps>(
  ({ className, href, children, ...props }, ref) => (
    <Link
      ...
      to={href}
      className={cn(
        'hover:text-tsinelas-text-strong text-tsinelas-text-disabled flex items-center gap-1.5 font-medium transition-colors',
        className
      )}
      {...props}
    >
