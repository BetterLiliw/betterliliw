...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title
    ref={ref}
    className={`tsinelas-heading-md leading-none tracking-tight ${className}`}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Description
    ref={ref}
    className={`text-tsinelas-text-disabled text-sm ${className}`}
    {...props}
  />
));
