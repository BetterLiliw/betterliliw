...
const getPriorityColor = (priority: string) => {
  switch (priority) {
    case 'high':
      return 'bg-tsinelas-bg-danger-weak text-tsinelas-text-danger';
    case 'medium':
      return 'bg-tsinelas-bg-warning-weak text-tsinelas-text-warning';
    case 'low':
      return 'bg-tsinelas-bg-success-weak text-tsinelas-text-success';
    default:
      return 'bg-tsinelas-bg-surface-raised text-tsinelas-text-strong';
  }
};
...
const getComplexityColor = (complexity: string) => {
  switch (complexity) {
    case 'simple':
      return 'bg-tsinelas-bg-info-weak text-tsinelas-text-info';
    case 'moderate':
      return 'bg-tsinelas-bg-accent-purple-weak text-tsinelas-text-accent-purple';
    case 'complex':
      return 'bg-tsinelas-bg-accent-orange-weak text-tsinelas-text-accent-orange';
    default:
      return 'bg-tsinelas-bg-surface-raised text-tsinelas-text-strong';
  }
};
      ...
      <div className='container mx-auto px-4 py-8 md:py-12'>
        ...
        <header className='mb-8 text-center md:mb-12'>
          <div className='mb-4 flex items-center justify-center'>
            <div className='bg-tsinelas-bg-surface text-tsinelas-text-brand mr-4 rounded-full p-3'>
          ...
          <p className='text-tsinelas-text-support mx-auto max-w-3xl text-sm md:text-lg'>
        ...
        <div className='mb-8 grid grid-cols-2 gap-4 md:mb-12 md:grid-cols-5'>
          <div className='bg-tsinelas-bg-surface rounded-lg p-4 text-center shadow-xs'>
            <div className='text-tsinelas-text-brand text-2xl font-bold'>
              {projectIdeas.length}
            </div>
            <div className='text-tsinelas-text-on-disabled text-sm'>
              Total Ideas
            </div>
          </div>
          <div className='bg-tsinelas-bg-surface rounded-lg p-4 text-center shadow-xs'>
            <div className='text-tsinelas-text-danger text-2xl font-bold'>
          ...
          <div className='bg-tsinelas-bg-surface rounded-lg p-4 text-center shadow-xs'>
            <div className='text-tsinelas-text-info text-2xl font-bold'>
          ...
          <div className='bg-tsinelas-bg-surface rounded-lg p-4 text-center shadow-xs'>
            <div className='text-tsinelas-text-success text-2xl font-bold'>
          ...
          <div className='bg-tsinelas-bg-surface rounded-lg p-4 text-center shadow-xs'>
            <div className='text-tsinelas-text-accent-purple text-2xl font-bold'>
            ...
            {projectIdeas
              ...
              .map(idea => (
                <Card
                  key={idea.id}
                  hoverable
                  className='bg-tsinelas-bg-surface h-full'
                >
                  <CardContent className='p-6'>
                    <div className='mb-4 flex items-start justify-between'>
                      <div className='flex flex-1 items-center'>
                        <div className='bg-tsinelas-bg-surface text-tsinelas-text-brand mr-3 rounded-lg p-2'>
                          {idea.icon}
                        </div>
                        <div className='flex-1'>
                          <h3 className='text-tsinelas-text-strong mb-1 text-xl font-semibold'>
                            {idea.title}
                          </h3>
                          <span className='bg-tsinelas-bg-hover text-tsinelas-text-support inline-block rounded-sm px-2 py-1 text-xs font-medium'>
                            {idea.category}
                          </span>
                        </div>
                      </div>
                    ...
                    <p className='text-tsinelas-text-support mb-4 leading-relaxed'>
                      {idea.description}
                    </p>
