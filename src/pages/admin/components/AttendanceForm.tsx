    ...
    <div className='space-y-6'>
      ...
      <Card variant='default'>
        ...
        <CardContent>
          <div className='flex flex-wrap gap-4'>
            <div>
              <p className='text-tsinelas-text-disabled text-xs'>Session Type</p>
              <p className='text-tsinelas-text-strong font-medium capitalize'>
                {session.session_type}
              </p>
            </div>
            {session.ordinal && (
              <div>
                <p className='text-tsinelas-text-disabled text-xs'>Number</p>
            ...
            <div>
              <p className='text-tsinelas-text-disabled text-xs'>Date</p>
              <p className='text-tsinelas-text-strong font-medium'>
      ...
      <Card variant='default'>
        ...
        <CardContent className='space-y-4'>
          {/* Summary */}
          <div className='bg-tsinelas-bg-surface-raised flex items-center justify-between rounded-md p-4'>
            <div className='flex gap-4'>
              <div>
                <p className='text-tsinelas-text-disabled text-xs'>
                  Total Members
                </p>
                <p className='text-tsinelas-text-strong text-lg font-bold'>
                  {members.length}
                </p>
              </div>
              <div>
                <p className='text-tsinelas-text-disabled text-xs'>Present</p>
                <p className='text-lg font-bold text-emerald-600'>
                  {presentCount}
                </p>
              </div>
              <div>
                <p className='text-tsinelas-text-disabled text-xs'>Absent</p>
