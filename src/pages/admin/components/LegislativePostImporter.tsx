...
...'
                      className='border-tsinelas-border-weak h-64 w-full rounded-md border px-3 py-2 font-mono text-sm'
                    />
                  </div>
                  <Button
                    variant='primary'
              ...
              <Card variant='default'>
                <CardContent className='p-4'>
                  <h4 className='text-tsinelas-text-strong mb-2 text-sm font-semibold'>
                    Supported Format
                  </h4>
              ...
              <Card variant='default'>
                <CardContent className='space-y-4 p-4'>
                  <div className='flex items-center gap-2'>
                    <Calendar className='text-tsinelas-text-disabled h-4 w-4' />
                  ...
                  <div className='grid gap-4 sm:grid-cols-2'>
                    <div>
                      <label className='text-tsinelas-text-support mb-1 block text-xs'>
                        Session Type
                      </label>
                      <select
                        value={sessionType}
                        ...
                        className='border-tsinelas-border-weak bg-tsinelas-bg-surface w-full rounded-md border px-3 py-2 text-sm'
                      >
                    ...
                    <div>
                      ...
                      <select
                        ...
                        className='border-tsinelas-border-weak bg-tsinelas-bg-surface disabled:bg-tsinelas-bg-surface-raised w-full rounded-md border px-3 py-2 text-sm'
                      >
                        {terms.map(term => (
                ...
                {editedDocuments.map((doc, index) => (
                  <Card key={index} variant='default'>
                    <CardContent className='p-4'>
                      <div className='flex items-start justify-between gap-4'>
                        <div className='min-w-0 flex-1'>
                          <div className='mb-2 flex items-center gap-2'>
                            ...
                            <span className='text-tsinelas-text-support font-mono text-xs'>
                              {doc.number}
                            </span>
                          </div>
                          <p className='text-tsinelas-text-strong line-clamp-2 text-sm font-medium'>
                            {doc.title}
                          </p>
                        ...
                        <div className='flex items-center gap-2'>
                          <button
                            ...
                            className='text-tsinelas-text-disabled hover:text-tsinelas-text-support p-1'
                          >
                          ...
                          <button
                            ...
                            className='hover:text-tsinelas-text-danger p-1 text-tsinelas-text-danger'
                      ...
                      {/* Expanded Details */}
                      {expandedItems.has(index) && (
                        <div className='border-tsinelas-border-weak mt-4 space-y-4 border-t pt-4'>
                          {/* Type */}
                          <div>
                            <label className='text-tsinelas-text-support mb-1 block text-xs'>
                              Document Type
                          ...
                          <div>
                            ...
                            <input
                              ...
                              className='border-tsinelas-border-weak w-full rounded-md border px-3 py-2 font-mono text-sm'
                            />
                          </div>
                        ...
                        <CardContent className='space-y-4 p-4'>
                          ...
                          <div className='space-y-3'>
                            ...
                            <div className='grid grid-cols-2 gap-4 text-sm'>
                              <div>
                                <span className='text-tsinelas-text-support mb-1 block font-medium'>
                                  Existing Title
                                </span>
                              ...
                              <div>
                                ...
                                <div className='flex flex-wrap gap-1'>
                                  ...
                                  dup.existing.authors.length > 0 ? (
                                    ...
                                    <span className='text-tsinelas-text-disabled italic'>
                                      No authors
                                    </span>
                                  )}
                                </div>
                          ...
                          {/* Resolution Options */}
                          <div>
                            <label className='text-tsinelas-text-support mb-2 block text-xs font-medium'>
                              Resolution
                            </label>
                              ...
                              <button
                                ...
                                className={`rounded-md border px-3 py-2 text-xs ${
                                  resolution.action === 'skip'
                                    ? 'bg-tsinelas-bg-brand-weak border-tsinelas-border-brand text-white'
                                    : 'hover:bg-tsinelas-bg-surface-raised border-tsinelas-border-weak'
                                }`}
                              >
                                Skip
                              </button>
                            ...
                            {(resolution.action === 'merge' ||
                              resolution.action === 'replace') && (
                              <div className='border-tsinelas-border-weak space-y-2 border-t pt-2'>
                                ...
                                <div className='flex flex-wrap gap-2'>
                                  <label className='flex items-center gap-1 text-xs'>
                                    <input
                                      ...
                                      className='border-tsinelas-border-weak rounded'
                                    />
                                    <span>Title</span>
                                  </label>
                                  <label className='flex items-center gap-1 text-xs'>
          ...
          {step === 'creating' && (
            <div className='flex flex-col items-center justify-center space-y-4 py-12'>
              <div className='border-t-primary-500 border-tsinelas-border-weak h-12 w-12 animate-spin rounded-full border-4' />
