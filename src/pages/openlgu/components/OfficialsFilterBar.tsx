    ...
    <div className='space-y-4'>
      ...
      <div className='relative'>
        <input
          ...
          className='focus:border-tsinelas-border-brand focus:ring-tsinelas-border-brand/20 border-tsinelas-border-weak bg-tsinelas-bg-surface w-full rounded-lg border px-4 py-2.5 pl-10 text-sm focus:ring-2 focus:outline-none'
        />
        <svg
          className='text-tsinelas-text-disabled absolute top-1/2 left-3 h-4 w-4 -translate-y-1/2'
          fill='none'
          stroke='currentColor'
          viewBox='0 0 24 24'
        >
        ...
        {searchQuery && (
          <button
            ...
            className='text-tsinelas-text-disabled hover:text-tsinelas-text-support absolute top-1/2 right-3 -translate-y-1/2'
