  ...
  return (
    <div className='space-y-4'>
      <div className='flex items-center justify-between'>
        <h2 className='text-tsinelas-text-disabled text-sm font-bold tracking-widest uppercase'>
          Officials
        </h2>
        <Link
          to='/openlgu/officials'
          className='text-tsinelas-text-brand hover:text-tsinelas-text-brand text-xs font-bold'
        >
          View all →
        </Link>
      </div>
              ...
              <Card variant='default' hover={true} className='h-full'>
                <CardContent className='p-4'>
                  <div className='flex items-start gap-3'>
                    <div className='from-tsinelas-brand-500 to-tsinelas-brand-600 text-tsinelas-text-inverse flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-linear-to-br text-sm font-bold shadow-sm'>
                      {initials}
                    </div>
                    <div className='min-w-0 flex-1'>
                      <div className='mb-1'>{getRoleBadge(person)}</div>
                      <p className='group-hover:text-tsinelas-text-brand text-tsinelas-text-strong truncate text-sm font-bold transition-colors'>
                        {getPersonName(person)}
                      </p>
                    </div>
                    <RoleIcon
                      className='group-hover:text-tsinelas-text-brand text-tsinelas-text-support h-4 w-4 shrink-0 transition-colors'
                      aria-hidden='true'
                    />
                  </div>
                </CardContent>
