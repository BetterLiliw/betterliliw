...
export default function TransparencyIndex() {
  ...
  return (
    <div className='animate-in fade-in duration-500'>
      ...
      <div className='mb-10'>
        <div className='bg-tsinelas-orange-50 flex flex-col items-center gap-6 rounded-3xl border-0 p-6 shadow-sm md:flex-row'>
          <div className='text-tsinelas-orange-600 bg-tsinelas-bg-surface rounded-2xl p-4 shadow-md'>
            <HeartHandshake className='h-8 w-8' />
          </div>
          <div className='flex-1 space-y-2 text-center md:text-left'>
            <h3 className='text-[10px] font-bold tracking-widest text-tsinelas-orange-600 uppercase'>
              Independent Grassroots Initiative
            </h3>
            <p className='text-sm leading-relaxed text-tsinelas-orange-600'>
      ...
      <CardGrid columns={3}>
        {sections.map(section => (
          ...
          >
            <Card
              hover
              className='border-tsinelas-border-weak flex h-full flex-col'
            >
              <CardContent className='flex h-full flex-col p-6'>
                <div className='mb-6 flex items-start justify-between'>
                  <div
                    className={`rounded-2xl p-3 shadow-sm transition-all ${
                      section.color === 'blue'
                        ? 'bg-tsinelas-bg-surface text-tsinelas-text-brand group-hover:bg-tsinelas-bg-brand-default group-hover:text-tsinelas-text-inverse'
                        : 'bg-tsinelas-orange-50 text-tsinelas-orange-600 group-hover:bg-tsinelas-orange-100 group-hover:text-tsinelas-text-inverse'
                    }`}
                  >
                ...
                <div className='flex-1 space-y-2'>
                  <h4 className='group-hover:text-tsinelas-text-brand text-tsinelas-text-strong text-lg font-extrabold transition-colors'>
                    {section.title}
                  </h4>
                ...
                <div className='mt-8 flex items-center justify-between border-t border-tsinelas-border-weak pt-4 transition-transform group-hover:translate-x-1'>
                  <span className='text-tsinelas-text-brand text-[10px] font-black tracking-widest uppercase'>
                    Analyze Data
                  </span>
                  <ChevronRight className='text-tsinelas-text-support h-4 w-4' />
                </div>
              </CardContent>
            </Card>
          </Link>
      ...
      <div className='mt-10 grid grid-cols-1 gap-8 md:grid-cols-2'>
        <DetailSection
          ...
          icon={Search}
          className='bg-tsinelas-bg-surface-raised border-tsinelas-border-weak flex h-full flex-col'
        >
          <div className='flex h-full flex-col justify-between'>
            <p className='text-tsinelas-text-support mb-6 text-sm leading-relaxed'>
        ...
        >
          <div className='flex h-full flex-col justify-between'>
            <p className='text-tsinelas-text-disabled mb-6 text-[11px] font-medium italic'>
